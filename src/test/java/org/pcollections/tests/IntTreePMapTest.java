...
public class IntTreePMapTest extends TestCase {
  ...
  public void testSpliterator() {
    IntTreePMap<String> map = IntTreePMap.<String>empty().plus(1, "v1").plus(2, "v2").plus(3, "v3").plus(4, "v4");
    Spliterator<Entry<Integer, String>> spliterator = map.entrySet().spliterator();
